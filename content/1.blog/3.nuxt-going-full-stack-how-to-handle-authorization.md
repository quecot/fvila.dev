...
To learn how to use it, see the GitHub repository: :gitHubLink{title="nuxt-authorization" href="https://github.com/barbapapazes/nuxt-authorization"}. If you want to learn more about the design and the implementation, continue reading.
...
Learn more at the GitHub repository: :gitHubLink{title="nuxt-authorization" href="https://github.com/barbapapazes/nuxt-authorization"}.
